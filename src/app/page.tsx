      ...
      <PullToRefresh onRefresh={handleRefresh}>
        ...
        {!isAuthenticated && (
          ...
          >
            ...
            >
              <span className="text-xl font-bold" style={{ color: '#F0C040' }}>π</span>
            </div>
            <h1 className="text-xl font-bold font-heading mb-1" style={{ color: '#F5F5F5' }}>
              Pi Bazaar
            </h1>
            <p className="text-xs mb-5 max-w-xs" style={{ color: '#9CA3AF' }}>
              Buy and sell with Pi — built for Pioneers.
            </p>
            <div className="flex items-center gap-2 w-full max-w-xs">
              <Link
                href="/login"
                className="flex-1 py-2 rounded-lg text-xs font-semibold text-center"
                style={{ backgroundColor: '#12121c', color: '#F5F5F5', border: '1px solid rgba(255,255,255,0.08)' }}
              >
                Log In
              </Link>
              <Link
