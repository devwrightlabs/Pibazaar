// Self-contained typed API client for the PiBazaar Express backend.
// All requests go through the dev proxy at `/api/*` (→ localhost:8080).
// Auth is a Bearer JWT persisted in localStorage.
...
const API_BASE = '/api'
const TOKEN_KEY = 'pibazaar-token'
...
export const escrowApi = {
  ...
  ship: (id: string, body: { trackingNumber?: string; carrier?: string }) =>
