...
const GOLD_ICON = L.divIcon({
  html: `<div style="width:24px;height:24px;background:var(--color-accent, var(--color-gold, #F0C040));border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:2px solid var(--color-bg);box-shadow:0 2px 8px var(--color-backdrop)"></div>`,
  className: '',
  iconSize: [24, 24],
  iconAnchor: [12, 24],
})
